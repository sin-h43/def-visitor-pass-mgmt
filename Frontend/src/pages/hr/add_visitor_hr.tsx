...
export default function AddVisitorHRPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pack escorts into the purpose payload securely
      ...
      <div className="max-w-4xl mx-auto pb-12 font-sans text-slate-800">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {/* Pipeline and Destination Variables */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-purple-50/40 p-4 border border-purple-100/60 rounded-xl">
              <div>
                ...
                <select 
                  ...
                  className="w-full p-2.5 border border-purple-200 rounded-xl bg-white text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-purple-500"
                >
            ...
            {/* HR SPECIFIC SELECTION AND CARD ID SUBSECTION */}
            ...
            {/* Document Scans Dropzone Component */}
